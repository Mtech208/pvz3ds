...
#ifdef PS2_PLATFORM
    // 64, not 1024: these are just the purchase/award coin effects inside the
    // store screen — a handful exist at once. ~200KB less while the store is up.
    mCoins.DataArrayInitialize(64U, "coins");
#else
