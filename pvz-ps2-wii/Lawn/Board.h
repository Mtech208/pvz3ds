...
//  inline bool						SyncState(DataSync& theDataSync) { /* 未发现 */return true; }
	...
	bool                            HasKeyboardSeedSelection() const;
	bool                            MoveKeyboardSeedSelection(int theStep);
	void                            ActivateKeyboardSeedSelection();
...
//	inline void						MouseDownNormal(int x, int y, int theClickCount) { /* 未发现 */; }
	...
	void							InvalidatePlantGridCache();
	void							RebuildPlantGridCache();
#endif
